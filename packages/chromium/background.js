...
ChatGPT:`;
  ...
  import_webextension_polyfill3.default.runtime.onConnect.addListener((port) => {
  ...
  import_webextension_polyfill3.default.runtime.onMessage.addListener(async (message) => {
    if (message.type === "FEEDBACK") {
      ...
      if (tab.glarityTabId) {
        import_webextension_polyfill3.default.tabs.update(tab.glarityTabId, { active: true });
      }
    }
  });
  ...
  import_webextension_polyfill3.default.tabs.onUpdated.addListener(async (tabId, changeInfo) => {
    ...
    import_webextension_polyfill3.default.tabs.get(tabId).then((tab) => {
      ...
      if (((_a = tab.url) == null ? void 0 : _a.includes("https://chat.openai.com")) && changeInfo.status === "complete" && tab.id && oldTabId.pinnedTabId === tab.id) {
